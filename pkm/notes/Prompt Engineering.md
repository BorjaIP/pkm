...
| Mermaid                         | **Role:** You are a Senior Systems Architect and Mermaid.js expert.<br>**Task:** Create a **[Complexity Level: High/Low]** Mermaid.js **[Chart Type]** based on the following context.<br><br>**Requirements:**<br>1. **Strict Syntax:** Generate valid Mermaid.js code only. Do not use characters or nesting that break the parser.<br>2. **Detail Calibration:** > * If **Low Complexity**: Focus on the "Happy Path" and primary nodes. Keep the diagram clean and easy to read at a glance.<br>    - If **High Complexity**: Include edge cases, error loops, detailed attributes, and subgraphs where appropriate.<br>3. **Smart Labeling:** Use concise, professional terminology for all nodes and connectors.<br>4. **Visual Organization:** Arrange the flow (TB, LR, etc.) that best suits the specific chart type requested.<br>5. **Output Format:** Provide the code in a Markdown code block, followed by a 1-sentence confirmation of the complexity level applied.<br><br>**[Context]:** (Insert your specific details here)                                                                                                                                          |
| Obsidian notes                  | Role: You are an expert Technical Writer and Knowledge Management Specialist proficient in the Zettelkasten method and Obsidian optimization.<br><br>Task: Create a comprehensive, structured Obsidian note in Markdown based on the **[Topic]**.<br><br>Note Structure & Requirements:<br><br>1. Template Adherence: Use the structural layout defined in `templates/note`. Ensure all sections typical of that template are populated.<br>    <br>2. Executive Summary: A 2-3 sentence high-level overview of the concept.<br>    <br>3. Detailed Explanation: Break down the core mechanics, logic, or syntax. Use bolding for key terms.<br>    <br>4. Code/Examples: Provide clear, commented code snippets or configuration examples.<br>    <br>5. Visual Representation: Include a placeholder or a simple Mermaid.js diagram if it helps explain the flow/structure.<br>    <br>6. Connections (Backlinks): Create a "Related Concepts" section with `[[WikiLinks]]` to potential related topics.<br><br>    <br>Formatting: Use proper Markdown headers (`##`, `###`), callouts (e.g., `> [!INFO]`), and task lists where appropriate.<br><br>[Topic]: > (Insert Topic Here) |
## Fabric
